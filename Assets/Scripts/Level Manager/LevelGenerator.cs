...
public class LevelGenerator : MonoBehaviour
{
    ...
    private void Update()
    {
        if (!mov.isGameOverCheck()) gameObject.transform.position += new Vector3(moveSpeed * Time.deltaTime, 0, 0);  //tiles movment X direction axis
        ...
        if (transform.position.x >= Index)
        {
            ...
            if (RandomInt2 == 0)
            {
                ...
                TempTile2.transform.position = new Vector3(-33, -0.25f, 0);
            }
            ...
            if (RandomInt3 == 0)
            {
                ...
                TempTile3.transform.position = new Vector3(-41, -0.25f, 0);
            }
